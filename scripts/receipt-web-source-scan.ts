...
export const RECEIPT_WEB_CONTAMINATION = /receipt-authority(?:\/server)?|edsk2gM2LioC6Yfk|issueSettledReceiptPermit|admitSettledReceiptPermit|deriveSettledServiceReceiptFacts|FIXTURE_SETTLED_COMMITMENT_NONCE|deterministicSettledCheckpointFixture|commitmentNonce|commitmentPreimage|issuerSignature|executablePermit|workerToken|leaseGeneration|SAMURAI_SUSHI_SERVICE_COMMITMENT_V1/;
